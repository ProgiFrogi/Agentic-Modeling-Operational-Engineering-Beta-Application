...
## Generating database
To generate database or add new content to it, you can run [creation](https://github.com/ProgiFrogi/Agentic-Modeling-Operational-Engineering-Beta-Application/blob/main/rag/creation.py). Main function is self explanatory. Pay attention that to run it you will need all env variables to be specified (except ones related to coder)
